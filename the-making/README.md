...
Documents from before the show had a shape. Not useful as reference. Useful as evidence — this is what the thinking looked like before the architecture existed.

**[Logline](./logline.md)** — The oldest artifact. Written before the pitch bible, before v1 went to coverage. The logline held. Everything else was built to make it true.
